...
export default function ActionComponent({ img, title, success, successText, hoverSuccessText, successAction, failure, failureText, hoverFailureText, failureAction, normalText, hoverNormalText, normalAction }: ActionComponentProps) {
    return (
